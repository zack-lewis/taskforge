...
export default function Login() {
  return (
    <>
      <div className="justify-content-center w-1/2 h-2/3 border-2 border-blue-500 rounded-3xl p-4 bg-slate-900 mx-auto relative top-32 flex flex-col">
        <div className="text-center">
          <h1 className="text-9xl">TaskForge</h1>
        </div>
